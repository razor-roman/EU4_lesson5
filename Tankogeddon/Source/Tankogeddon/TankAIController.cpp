...
void ATankAIController::Tick(float DeltaTime)
{
	...
	TankPawn->RotateLeft(rotationValue);
...
float ATankAIController::GetRotatingValue()
{
		...
		if(FVector::Distance(currentPoint, pawnLocation) <= MovementAccurency)
		{
			...
			UE_LOG(LogTemp, Warning, TEXT("CurrentPatrolPointIndex : %f PatrollingPoints.Num() : %f"),CurrentPatrolPointIndex,PatrollingPoints.Num());	
